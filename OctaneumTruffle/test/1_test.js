...
var Token = artifacts.require("OctaneumToken");

var TokenName = "Octaneum";
var Symbol = "OCT";
var TokenSupply = 100000000;
var Decimals = 8;
var TokenPrice = 1575000000000000;
...
contract("Token contract", function(accounts){
  ...
  contract ("Deploy Crowdsale contract", function(accounts){
    ...
    describe ("sendEther", function(){
      it("check acc0 Ether balance", function(){
    ...
    describe ("Checking amount bonus",function(){
      ...
      // it("change time Test",function(){
      
      //   console.log(web3.eth.getBlock(web3.eth.blockNumber).timestamp);
      //   return web3.currentProvider.send({jsonrpc: "2.0", method: "evm_increaseTime", params: [151793], id: 0}).then(function(res){
      //     return web3.currentProvider.send({jsonrpc: "2.0", method: "evm_mine", params: [], id: 0}).then(function(res){
      //       console.log(web3.eth.getBlock(web3.eth.blockNumber).timestamp);
